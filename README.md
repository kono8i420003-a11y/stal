...
Лендинг школы рукопашного боя «СТАЛЬ» (г. Ставрополь). Решает проблему ручного приёма заявок: посетитель оставляет заявку на пробную тренировку или вопрос на сайте, она мгновенно уходит администратору в Telegram и сохраняется в базе — ничего не нужно записывать вручную или проверять почту.

**Демо:** https://stal-seven.vercel.app
...
| Главный экран | Тренеры | Форма заявки |
|---|---|---|
| ![Hero](docs/screenshots/hero.png) | ![Тренеры](docs/screenshots/trainers.png) | ![Форма заявки](docs/screenshots/trial-form.png) |
